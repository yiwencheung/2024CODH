...
HD_PWD='D:/Projects/2024CODH/labs/lab4/sorting_env/run_vivado/CPU_SRT/CPU_SRT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort_top.tcl

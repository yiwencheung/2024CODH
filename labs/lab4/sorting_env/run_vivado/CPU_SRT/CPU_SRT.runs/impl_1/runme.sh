...
HD_PWD='D:/Projects/2024CODH/labs/lab4/sorting_env/run_vivado/CPU_SRT/CPU_SRT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sort_top.tcl -notrace

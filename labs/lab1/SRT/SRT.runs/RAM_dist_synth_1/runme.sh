...
HD_PWD='D:/Projects/2024CODH/labs/lab1/SRT/SRT.runs/RAM_dist_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_dist.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_dist.tcl

...
namespace eval ::optrace {
  variable script "D:/Projects/2024CODH/labs/lab1/SRT/SRT.runs/RAM_dist_synth_1/RAM_dist.tcl"
...
set_property webtalk.parent_dir D:/Projects/2024CODH/labs/lab1/SRT/SRT.cache/wt [current_project]
set_property parent.project_path D:/Projects/2024CODH/labs/lab1/SRT/SRT.xpr [current_project]
set_property default_lib xil_defaultlib [current_project]
set_property target_language Verilog [current_project]
set_property ip_output_repo d:/Projects/2024CODH/labs/lab1/SRT/SRT.cache/ip [current_project]
...
set cacheID [config_ip_cache -export -no_bom  -dir D:/Projects/2024CODH/labs/lab1/SRT/SRT.runs/RAM_dist_synth_1 -new_name RAM_dist -ip [get_ips RAM_dist]]
...
synth_design -top RAM_dist -part xc7a100tcsg324-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix RAM_dist_ RAM_dist.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ RAM_dist_stub.v
 lappend ipCachedFiles RAM_dist_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ RAM_dist_stub.vhdl
 lappend ipCachedFiles RAM_dist_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ RAM_dist_sim_netlist.v
 lappend ipCachedFiles RAM_dist_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ RAM_dist_sim_netlist.vhdl
 lappend ipCachedFiles RAM_dist_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp RAM_dist.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips RAM_dist]
 }
...
rename_ref -prefix_all RAM_dist_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef RAM_dist.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "RAM_dist_synth_1_synth_report_utilization_0" "report_utilization -file RAM_dist_utilization_synth.rpt -pb RAM_dist_utilization_synth.pb"

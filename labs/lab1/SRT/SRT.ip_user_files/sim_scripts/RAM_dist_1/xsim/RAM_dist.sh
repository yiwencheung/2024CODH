...
#
# Script generated by Vivado on Wed Mar 27 16:53:13 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RAM_dist.sh
...
#
# Usage        : RAM_dist.sh
#                RAM_dist.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM_dist.sh [-reset_run]
#                RAM_dist.sh [-reset_log]
#                RAM_dist.sh [-help]
#
...
# script info
echo -e "RAM_dist.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM_dist.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_dist xil_defaultlib.RAM_dist xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RAM_dist -key {Behavioral:sim_1:Functional:RAM_dist} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RAM_dist.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RAM_dist.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RAM_dist.sh [-help]\n\
Usage: RAM_dist.sh [-step]\n\
Usage: RAM_dist.sh [-lib_map_path]\n\
Usage: RAM_dist.sh [-reset_run]\n\
Usage: RAM_dist.sh [-reset_log]\n\
Usage: RAM_dist.sh [-keep_index]\n\
Usage: RAM_dist.sh [-noclean_files]\n\n\

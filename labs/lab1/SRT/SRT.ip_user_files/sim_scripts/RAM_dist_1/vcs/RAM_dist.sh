...
#                script (type 'RAM_dist.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.RAM_dist xil_defaultlib.glbl -o RAM_dist_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RAM_dist_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key RAM_dist_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RAM_dist_simv.daidir vcs_lib c.obj)

...
HD_PWD='D:/Projects/2024CODH/labs/lab1/SRT_FPGAOL/SRT_FPGAOL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SRT_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SRT_top.tcl -notrace

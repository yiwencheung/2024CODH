...
HD_PWD='D:/Projects/2024CODH/labs/lab1/SRT_FPGAOL/SRT_FPGAOL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRT_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRT_top.tcl
